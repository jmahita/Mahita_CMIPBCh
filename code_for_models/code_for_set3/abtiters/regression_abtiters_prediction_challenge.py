...
df1 = pd.read_csv(r'2020_2021_PT_abtiters_batchcorr.csv')
#df1b = df1[["Age","infancy_vac","biological_sex","race","day_0_MFI_normalised","day_14_MFI_normalised"]]#,"Fold_change"]]
df1b = df1[["day_0_batch_corr","FC_batchcorr"]]
