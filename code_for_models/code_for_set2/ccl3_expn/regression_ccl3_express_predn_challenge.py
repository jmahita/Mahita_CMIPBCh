...
df1 = pd.read_csv(r'ccl3exp_2021_day0_3.csv') #the file "ccl3exp_2021_day0_3.csv" is used as the training dataset
df1b = df1[["infancy_vac","biological_sex","fold_change"]]
...
df2 = pd.read_csv(r'2022_ccl3_geneexpr_day0_predn_task.csv')
subject_id = df2["subject_id"]
df2b = df2[["infancy_vac","biological_sex"]]
